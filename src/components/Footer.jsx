...
import { Github, Linkedin, Twitter, Mail, Globe, Heart, Rocket } from 'lucide-react';
    ...
    <footer className="relative bg-void-50 dark:bg-void-900 border-t border-void-200 dark:border-starlight-800/30 mt-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          >
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-10 h-10 bg-gradient-to-br from-cosmos-500 to-nebula-600 rounded-lg flex items-center justify-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-lg font-display font-semibold mb-4 text-void-900 dark:text-starlight-100">
              Quick Links
            </h3>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="pt-8 border-t border-void-200 dark:border-starlight-800/30 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0"
        >
          <p className="text-void-500 dark:text-starlight-500 text-sm flex items-center space-x-2">
            <span>© {currentYear} {personalData?.name}. All rights reserved.</span>
          </p>
          <p className="text-void-500 dark:text-starlight-500 text-sm flex items-center space-x-2">
            <span>Built with</span>
            <Heart className="w-4 h-4 text-cosmos-500 animate-pulse" />
